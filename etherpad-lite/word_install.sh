...
cp /home/pi/cdn-office-suite/etherpad-lite/settings.json /home/pi/etherpad-lite/settings.json
...
sudo cp etc/systemd/system/etherpad.service /etc/systemd/system/etherpad.service
